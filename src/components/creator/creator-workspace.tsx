...
export function CreatorWorkspace() {
  ...
  return <div className="studio-layout">
    <aside className="studio-sidebar"><b>CREATOR STUDIO</b><a href="#overview">Overview</a><a href="#analytics">Analytics</a><a href="#releases">Releases</a><a href="#titles">Titles</a><a href="#uploads">Uploads</a><a href="#team">Team</a></aside>
