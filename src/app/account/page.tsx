...
export default async function AccountPage() {
  let email = "Connect Supabase to load your account";
  let name = "AniVerse viewer";
  try {
    ...
    /* Setup state is intentionally renderable. */
  }
  const links = [
    {
    ...
    <main className="account-page">
      ...
      <section className="account-wrap">
        ...
        <div className="creator-callout">
          <div>
            <p>SHARE YOUR UNIVERSE</p>
            <h2>Are you an animation creator?</h2>
            <span>
              Apply for a verified creator profile and publish your original
              work.
            </span>
          </div>
          <Link href="/creator/apply">Apply to create</Link>
        </div>
      </section>
    </main>
  );
